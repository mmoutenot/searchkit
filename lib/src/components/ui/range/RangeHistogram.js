...
var RangeHistogram = (function (_super) {
    ...
    RangeHistogram.prototype.render = function () {
        ...
        var bars = map(items, function (_a) {
            var key = _a.key, key_as_string = _a.key_as_string, doc_count = _a.doc_count;
            var comparisonKey = isKeyStringValidDate(key_as_string) ? getYear(key_as_string) : key;
            var outOfBounds = (comparisonKey < minValue || comparisonKey > maxValue);
